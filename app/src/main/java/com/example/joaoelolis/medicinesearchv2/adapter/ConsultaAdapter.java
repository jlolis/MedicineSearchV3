...
import com.example.joaoelolis.medicinesearchv2.Cadastrar;
import com.example.joaoelolis.medicinesearchv2.ChamarBula;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        btnBula.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), ChamarBula.class);
